...
TEST(TestTreeNode, TestDeleteTree) {

    // Cоздаётся указатель на корень дерева 
    TreeNode<int>* root1 = createTree1();
    EXPECT_EQ(nullptr, deleteTree(root1));

    // Вырожденное вправо
    TreeNode<int>* root2 = createTree2();
    EXPECT_EQ(nullptr, deleteTree(root2));

    // Вырожденное влево
    TreeNode<int>* root3 = createTree3();
    EXPECT_EQ(nullptr, deleteTree(root3));

    // Завершённое дерево
    TreeNode<int>* root4 = createTree4();
    EXPECT_EQ(nullptr, deleteTree(root4));

    // Пустое дерево
    TreeNode<int>* root5 = nullptr;
    EXPECT_EQ(nullptr, deleteTree(root5));

    // Дерево с одним узлом
    TreeNode<int>* root6 = new TreeNode<int>(2);
    EXPECT_EQ(nullptr, deleteTree(root6));
}


// Тест копирования дерева используя сравнение векторов
TEST(TestTreeNode, TestСopyTree) {
    ...
    // Обычное дерево
    createVectorNLR(root1, vec);
    createVectorNLR(copy1, vec1);
    EXPECT_EQ(vec, vec1);
    ...
    // Вырожденное вправо
    TreeNode<int>* root2 = createTree2();
    TreeNode<int>* copy2 = copyTree(root2);

    createVectorNLR(root2, vec);
    createVectorNLR(copy2, vec1);
    EXPECT_EQ(vec, vec1);
    ...
    // Вырожденное влево
    TreeNode<int>* root3 = createTree3();
    TreeNode<int>* copy3 = copyTree(root3);

    createVectorNLR(root3, vec);
    createVectorNLR(copy3, vec1);
    EXPECT_EQ(vec, vec1);
    ...
    // Завершённое дерево
    TreeNode<int>* root4 = createTree4();
    TreeNode<int>* copy4 = copyTree(root4);

    createVectorNLR(root4, vec);
    createVectorNLR(copy4, vec1);
    EXPECT_EQ(vec, vec1);
    ...
    // Пустое дерево
    TreeNode<int>* root5 = nullptr;
    TreeNode<int>* copy5 = copyTree(root5);

    createVectorNLR(root5, vec);
    createVectorNLR(copy5, vec1);
    EXPECT_EQ(vec, vec1);
    ...
    // Дерево с одним узлом
    TreeNode<int>* root6 = new TreeNode<int>(2);
    TreeNode<int>* copy6 = copyTree(root6);

    createVectorNLR(root6, vec);
    createVectorNLR(copy6, vec1);
    EXPECT_EQ(vec, vec1);
...
// Тест поиск узла
TEST(TestTreeNode, TestSearchNode) {
...
TEST(TestTreeNode, TestInsertNode) {
    ...
    TreeNode<int>* root3 = createTree3();
    expected = { 60, 42, 14, 21, 13, 0 };
    root3 = InsertNode(root3, 0);
    ...
    // 1   3  5        
    TreeNode<int>* root4 = createTree4();
    //expected = { 8, 4, 2, 1, 3, 7, 5, 6, 10, 9, 30 };
...
TEST(TestTreeNode, TestRemoveNode) {
    ...
    vector<int> result, expected = { 10, 4, 22, 12, 24 };
    ...
    TreeNode<int>* root3 = createTree3();
    expected = { 42, 14, 21, 13 };
    root3 = removeNode(root3, 60);
